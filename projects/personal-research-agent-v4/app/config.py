"""Runtime configuration for Personal Research Agent v4."""
...
def load_app_config(env_file: str | Path | None = None) -> AppConfig:
    ...
    resolved_db_path = str(resolve_project_path(db_path_value))
    return AppConfig(
        db_backend=db_backend,
        db_path=resolved_db_path,
        runtime_db_path=None if database_url else resolved_db_path,
